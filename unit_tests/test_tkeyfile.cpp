...
static void kv_cb(void *key, void *value, void *userdata)
{
...
static void kv_failed_cb(void *key, void *value, void *userdata)
{
    if (0 == strcmp((const char *)key, "flag2"))
    {
        EXPECT_STREQ("b", (char *)value);
...
TEST(TkeyfileTest, Function)
{
    ...
    // foreach test
    t_keyfile_group_foreach(keyfile, groups[0], kv_cb, NULL);
    t_keyfile_group_foreach(keyfile, groups[0], kv_failed_cb, NULL);
